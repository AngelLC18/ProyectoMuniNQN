    ...
    return (
        <>
          <div className="container">
            <div className="form">
              <div className='cajaTitle'><p  class="cajaTitle">CURSO</p></div>
              <div className='cajaDescripcion'><p  class="cajaDescripcion">¿De que trata nuestro curso? </p></div>
              <p className='cajaSubtitulo'>En este curso te brindaremos todos los conocimientos que necesitas para el manejo de computadoras y para poder llevar la tecnologia de la mejor manera , inscribite aca</p>
              <div class="form-row">
                <label class="name">
                  <span>Nombre</span>
